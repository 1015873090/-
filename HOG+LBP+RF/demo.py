...
import numpy as np
import joblib
from model import EMOTIONS, extract_hog_features, extract_lbp_features, extract_features
...
def format_image(image):
    ...
    try:
        ...
        # 使用统一特征提取方式（混合 HOG 和 LBP）
        hybrid_features = extract_features(face_img)
        return hybrid_features, (x, y, w, h)
