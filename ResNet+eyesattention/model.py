...
class EyeAttention(nn.Module):
    ...
    def __init__(self, in_channels):
        ...
        self.conv = nn.Sequential(
            ...
            nn.ReLU(inplace=True),
            nn.Conv2d(64, in_channels, kernel_size=1),  # 保持通道数一致
            nn.Sigmoid()  # 生成注意力掩码
        )
...
class ResNetEmotion(nn.Module):
    ...
    def __init__(self, num_classes=7, pretrained=True):
        ...
        # 注意力机制（插入在layer3后）
        self.eye_attention = EyeAttention(1024)  # layer3输出通道数为1024
